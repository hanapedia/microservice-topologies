...
import (
  ...
  "fmt"
	...
	"github.com/hanapedia/microservice-topologies/test-2/fanout-1/connections/mongo"
	pb "github.com/hanapedia/microservice-topologies/test-2/fanout-1/pb-fanout-1"
...
func (s fanout_1Server) GetIds(ctx context.Context, req *pb.Req) (*pb.Res, error) {
	...
	if err != nil {
		log.Printf("Failed to retrieve item at fanout_1: %v", err)
	}
	returnArr := req.Ids
